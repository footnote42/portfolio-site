...
const milestones: Milestone[] = [
  ...
  },
  {
    ...
    details: [
      'Lightweight structure gave momentum without killing curiosity, and tools began to fade into the background',
      'Took a multi-model AI concept from idea to live deployment',
